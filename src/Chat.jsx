...
return (
  <div className="h-[660px] p-5 w-[90%] md:w-[80%] flex flex-col rounded-3xl border border-black/10 bg-gradient-to-br from-[#020409] via-[#040c1c] to-[#17012e] shadow-2xl shadow-black/50 overflow-hidden">
    ...
    <div class="py-2">
      <div class="flex items-center ">
        <textarea
          ...
          class="break-words resize-none overflow-y-auto w-full border-2 rounded-2xl py-2 px-4 mr-2 border-white"
          type="text"
        ...
        <button
          onClick={sendmsg}
          class="bg-blue-700 hover:bg-blue-600 text-white text-sm py-2 md:px-4 rounded-full w-26"
        >
          Send ➤
        </button>
