...
export const Baseurl="/api"  //make change from http://localhost:3333 to this, rest everything would be taken
// as now we are making api calls in ip/api/login format....

//to run in npm run dev or local, use localhost not /api  will fix it using .env
